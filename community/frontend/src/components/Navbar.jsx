...
const Navbar = () => {
  ...
  return (
    ...
    <h1 className="text-lg md:text-xl font-bold"><Link to="/">Community page</Link></h1>
    ...
    <div className="hidden md:flex items-center justify-center space-x-2 md:space-x-4">
      {user? <h3><Link to="http://localhost:3000/">Home</Link></h3> :<h3><Link to="/login">Login</Link></h3>}
