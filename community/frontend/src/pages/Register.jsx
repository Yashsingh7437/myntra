...
const Register = () => {
  ...
  return (
    ...
    <Link to="/" className="text-xl font-bold text-[#FF3E6C] ">Myntra</Link></h1>
    ...
    <div className="w-full flex justify-center items-center h-[80vh] ">
       <div className="flex flex-col justify-center items-center space-y-4 w-[80%] md:w-[25%]">
         ...
         <div className="flex justify-center items-center space-x-3">
          ...
          <p className="text-white-500 font-bold bg-[#FF3E6C] hover:text-black rounded-md"><Link to="/login">Login</Link></p>
         </div>
       </div>
    </div>
    <Footer/>
